...
var _breachedAccount = require('./breachedAccount');

var _breachedAccount2 = _interopRequireDefault(_breachedAccount);

var _pasteAccount = require('./pasteAccount');

var _pasteAccount2 = _interopRequireDefault(_pasteAccount);
...
var search = function search(account) {
  ...
  return Promise.all([(0, _breachedAccount2.default)(account, breachOptions),
  // This email regex is garbage but it seems to be what the API uses:
  /^.+@.+$/.test(account) ? (0, _pasteAccount2.default)(account) : null]).then(function (breachesAndPastes) {
    return {
