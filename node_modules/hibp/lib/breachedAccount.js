...
var _fetchFromApi = require('./internal/fetchFromApi');

var _fetchFromApi2 = _interopRequireDefault(_fetchFromApi);
...
var breachedAccount = function breachedAccount(account) {
  ...
  return (0, _fetchFromApi2.default)('' + endpoint + params.join('&'));
};
 ...
 */
exports.default = breachedAccount;
